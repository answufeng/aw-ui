...
class AwTitleBar @JvmOverloads constructor(
    ...
    var barHeightPx: Int = 56f.dp().toInt()
        set(value) {
            val safe = value.coerceAtLeast(48f.dp().toInt())
    ...
    var subtitleColor: Int = Color.parseColor("#99000000")
        set(value) {
            field = value
    ...
    var dividerColor: Int = Color.parseColor("#14000000")
        set(value) {
            field = value
    ...
    init {
        ...
        leftContainer = FrameLayout(context).apply {
            layoutParams = LayoutParams(48f.dp().toInt(), barHeightPx).apply {
        ...
        ivBack = ImageView(context).apply {
            ...
            setPadding(12f.dp().toInt(), 0, 12f.dp().toInt(), 0)
        ...
        centerContainer = LinearLayout(context).apply {
            ...
            layoutParams = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT).apply {
                gravity = Gravity.CENTER
                marginStart = 56f.dp().toInt()
                marginEnd = 56f.dp().toInt()
            }
        }
        ...
        rightContainer = LinearLayout(context).apply {
            ...
            layoutParams = LayoutParams(LayoutParams.WRAP_CONTENT, barHeightPx).apply {
                gravity = Gravity.END or Gravity.CENTER_VERTICAL
                marginEnd = 4f.dp().toInt()
            }
        }
        ...
        tvRight = TextView(context).apply {
            ...
            gravity = Gravity.CENTER
            setPadding(10f.dp().toInt(), 0, 10f.dp().toInt(), 0)
            visibility = GONE
        }
        rightContainer.addView(tvRight)

        ivRight = ImageView(context).apply {
            layoutParams = LinearLayout.LayoutParams(48f.dp().toInt(), barHeightPx)
            scaleType = ImageView.ScaleType.CENTER
            setPadding(12f.dp().toInt(), 0, 12f.dp().toInt(), 0)
        ...
        dividerView = View(context).apply {
            layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, 1f.dp().toInt()).apply {
        ...
        dividerColor = ta.getColor(R.styleable.AwTitleBar_titleBar_dividerColor, Color.parseColor("#14000000"))
        barHeightPx = ta.getDimensionPixelSize(R.styleable.AwTitleBar_titleBar_height, 56f.dp().toInt())
    ...
    fun setRightText(text: CharSequence?, listener: OnClickListener? = null) {
        tvRight.text = text
    ...
    private fun applyIconTint(drawable: Drawable?, color: Int?): Drawable? {
