...
class AwSegmentedControl
    ...
    constructor(
        ...
        private var dotDrawable: GradientDrawable =
        ...
        var textColor: Int = 0x99000000.toInt()
            set(value) {
                field = value
                updateTextColors()
            }

        var selectedTextColor: Int = 0xFF000000.toInt()
            set(value) {
                field = value
        ...
        init {
            ...
            selectedTextColor =
                ta.getColor(
                    ...
                    ContextCompat.getColor(context, R.color.aw_color_seg_selected_text),
                )
            ...
            containerDrawable.setColor(ContextCompat.getColor(context, R.color.aw_color_seg_container_bg))
            ...
            selectionAppearance = SelectionAppearance.entries.getOrElse(appFromXml) { SelectionAppearance.PILL }
            accessoryIndicator = AccessoryIndicator.entries.getOrElse(accFromXml) { AccessoryIndicator.NONE }
            applyHighlightAndAccessoryLayout()
        ...
        private fun applyIconToImageView(
            target: ImageView,
            tab: SegmentTab,
            index: Int,
        ) {
