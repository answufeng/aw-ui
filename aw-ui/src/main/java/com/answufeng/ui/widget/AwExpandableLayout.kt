 ...
 */
class AwExpandableLayout @JvmOverloads constructor(
    context: Context,
    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(measuredChildHeight + paddingTop + paddingBottom, MeasureSpec.EXACTLY))
    }
